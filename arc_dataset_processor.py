...
This script processes the ARC Prize 2025 training data:
1. Merges training challenges with their solutions
2. Creates 10-fold cross-validation splits
3. Prepares datasets for ARC-IDEA training
...
Output:
- merged_arc_training_data.json
- arc_k_fold_splits/ (directory with 10 fold files)
"""
...
class ARCDatasetProcessor:
    ...
    def load_raw_data(self) -> Tuple[Dict, Dict]:
        ...
        try:
            ...
            print(f"❌ Failed to load challenges: {e}")
            return {}, {}
    ...
    def merge_challenges_with_solutions(self, challenges: Dict, solutions: Dict) -> Dict:
        ...
        print(f"✅ Successfully merged {matched_count} challenge-solution pairs")
        
        if unmatched_challenges:
            print(f"⚠️  {len(unmatched_challenges)} challenges without solutions:")
    ...
    def save_processed_data(self, output_dir: str = "arc_processed_data"):
        ...
        for fold_name, fold_data in self.k_fold_splits.items():
            ...
            print(f"✅ Saved {fold_name}: {fold_file}")
...
def main():
    ...
    if success:
        print("\n🎉 ARC Dataset Processing Completed Successfully!")
        print("\nGenerated Files:")
